...
def styled_metric(label, value, delta=None, delta_prefix="", help=None):
    ...
    st.markdown(
        f"""
        <div style="padding:16px; background:linear-gradient(135deg, #F5F7FA 0%, #E8EAF6 100%);
            ...
            <div style="color:{COLORS['primary']}; font-size:28px; font-weight:700; margin-top:4px;">{value}</div>
            {delta_html}
        </div>
        """,
